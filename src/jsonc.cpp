...
JsoncValueType jsonc_get_variant_type(JsoncTypeVariantHandle handle) {
    return static_cast<JsoncValueType>(static_cast<jsonc::jsonc*>(handle)->type());
}

bool     jsonc_variant_to_bool(JsoncTypeVariantHandle handle) { return static_cast<jsonc::jsonc*>(handle)->get<bool>(); }
int64_t  jsonc_variant_to_signed(JsoncTypeVariantHandle handle) { return static_cast<jsonc::jsonc*>(handle)->get<int64_t>(); }
uint64_t jsonc_variant_to_unsigned(JsoncTypeVariantHandle handle) { return static_cast<jsonc::jsonc*>(handle)->get<uint64_t>(); }
double   jsonc_variant_to_float(JsoncTypeVariantHandle handle) { return static_cast<jsonc::jsonc*>(handle)->get<double>(); }

const char* jsonc_variant_as_string(JsoncTypeVariantHandle handle) { return static_cast<jsonc::jsonc*>(handle)->as<std::string>().c_str(); }
const char* jsonc_variant_as_big_int(JsoncTypeVariantHandle handle) {
    return static_cast<jsonc::jsonc*>(handle)->as<jsonc::detail::basic_big_int>().view_.c_str();
}

JsoncObjectHandle jsonc_variant_as_object(JsoncTypeVariantHandle handle) { return &static_cast<jsonc::jsonc*>(handle)->as<jsonc::object_type>(); }
JsoncArrayHandle  jsonc_variant_as_array(JsoncTypeVariantHandle handle) { return &static_cast<jsonc::jsonc*>(handle)->as<jsonc::array_type>(); }
...
const char* jsonc_variant_get_comments_before(JsoncTypeVariantHandle handle) {
    if (static_cast<jsonc::jsonc*>(handle)->has_before_comments()) {
        std::string result{};
        for (auto& comment : static_cast<jsonc::jsonc*>(handle)->before_comments()) {
...
const char* jsonc_variant_get_comments_after(JsoncTypeVariantHandle handle) {
    if (static_cast<jsonc::jsonc*>(handle)->has_after_comments()) {
        std::string result{};
        for (auto& comment : static_cast<jsonc::jsonc*>(handle)->after_comments()) {
            result.append(comment);
            result.push_back('\n');
        }
        result.pop_back();
...
void jsonc_variant_merge_comments(JsoncTypeVariantHandle lhs, JsoncTypeVariantHandle rhs) {
    static_cast<jsonc::jsonc*>(lhs)->merge_comments(*static_cast<jsonc::jsonc*>(rhs));
}

void jsonc_variant_set_comments_before(JsoncTypeVariantHandle handle, const char* comments) {
    static_cast<jsonc::jsonc*>(handle)->before_comments() = jsonc::detail::split_comments(comments);
}
void jsonc_variant_set_comments_after(JsoncTypeVariantHandle handle, const char* comments) {
    static_cast<jsonc::jsonc*>(handle)->after_comments() = jsonc::detail::split_comments(comments);
}
...
bool jsonc_object_contains(JsoncObjectHandle handle, const char* key) { return static_cast<jsonc::object_type*>(handle)->contains(key); }

bool jsonc_object_value_is_any_int_type(JsoncObjectHandle handle, const char* key) {
...
JsoncValueType jsonc_object_get_type(JsoncObjectHandle handle, const char* key) {
    return static_cast<JsoncValueType>(static_cast<jsonc::object_type*>(handle)->operator[](key).type());
}

bool jsonc_object_get_bool(JsoncObjectHandle handle, const char* key) {
    return static_cast<jsonc::object_type*>(handle)->operator[](key).get<bool>();
}
...
int64_t jsonc_object_get_signed(JsoncObjectHandle handle, const char* key) {
    return static_cast<jsonc::object_type*>(handle)->operator[](key).get<int64_t>();
}
...
uint64_t jsonc_object_get_unsigned(JsoncObjectHandle handle, const char* key) {
    return static_cast<jsonc::object_type*>(handle)->operator[](key).get<uint64_t>();
}
void jsonc_object_set_unsigned(JsoncObjectHandle handle, const char* key, uint64_t value) {
    static_cast<jsonc::object_type*>(handle)->operator[](key) = value;
}

const char* jsonc_object_get_any_int(JsoncObjectHandle handle, const char* key) {
    return make_cstr(static_cast<jsonc::object_type*>(handle)->operator[](key).get_any_int_view());
}
bool jsonc_object_set_any_int(JsoncObjectHandle handle, const char* key, const char* value) {
...
size_t jsonc_object_get_size(JsoncObjectHandle handle) { return static_cast<jsonc::object_type*>(handle)->size(); }
...
void jsonc_object_clear(JsoncObjectHandle handle) { static_cast<jsonc::object_type*>(handle)->clear(); }

bool jsonc_object_remove(JsoncObjectHandle handle, const char* key) { return static_cast<jsonc::object_type*>(handle)->erase(key); }
...
bool jsonc_array_get_bool(JsoncArrayHandle handle, size_t index) { return static_cast<jsonc::array_type*>(handle)->operator[](index).get<bool>(); }
void jsonc_array_set_bool(JsoncArrayHandle handle, size_t index, bool value) { static_cast<jsonc::array_type*>(handle)->operator[](index) = value; }
void jsonc_array_add_bool(JsoncArrayHandle handle, bool value) { static_cast<jsonc::array_type*>(handle)->push_back(value); }

int64_t jsonc_array_get_signed(JsoncArrayHandle handle, size_t index) {
    return static_cast<jsonc::array_type*>(handle)->operator[](index).get<int64_t>();
}
void jsonc_array_set_signed(JsoncArrayHandle handle, size_t index, int64_t value) {
    static_cast<jsonc::array_type*>(handle)->operator[](index) = value;
}
void jsonc_array_add_signed(JsoncArrayHandle handle, int64_t value) { static_cast<jsonc::array_type*>(handle)->push_back(value); }

uint64_t jsonc_array_get_unsigned(JsoncArrayHandle handle, size_t index) {
    return static_cast<jsonc::array_type*>(handle)->operator[](index).get<uint64_t>();
}
void jsonc_array_set_unsigned(JsoncArrayHandle handle, size_t index, uint64_t value) {
    static_cast<jsonc::array_type*>(handle)->operator[](index) = value;
}
void jsonc_array_add_unsigned(JsoncArrayHandle handle, uint64_t value) { static_cast<jsonc::array_type*>(handle)->push_back(value); }

const char* jsonc_array_get_any_int(JsoncObjectHandle handle, size_t index) {
    return make_cstr(static_cast<jsonc::array_type*>(handle)->operator[](index).get_any_int_view());
}
bool jsonc_array_set_any_int(JsoncObjectHandle handle, size_t index, const char* value) {
    auto val = jsonc::jsonc::from_big_int(value);
    if (val) { static_cast<jsonc::array_type*>(handle)->operator[](index) = *val; }
    return val.has_value();
}
bool jsonc_array_add_any_int(JsoncArrayHandle handle, const char* value) {
    auto val = jsonc::jsonc::from_big_int(value);
    if (val) { static_cast<jsonc::array_type*>(handle)->push_back(*val); }
    return val.has_value();
}

double jsonc_array_get_float(JsoncArrayHandle handle, size_t index) {
    return static_cast<jsonc::array_type*>(handle)->operator[](index).get<double>();
}
void jsonc_array_set_float(JsoncArrayHandle handle, size_t index, double value) {
    static_cast<jsonc::array_type*>(handle)->operator[](index) = value;
}
void jsonc_array_add_float(JsoncArrayHandle handle, double value) { static_cast<jsonc::array_type*>(handle)->push_back(value); }
...
void jsonc_array_add_string(JsoncArrayHandle handle, const char* value) {
    static_cast<jsonc::array_type*>(handle)->push_back(std::string_view(value));
}
...
size_t jsonc_array_get_size(JsoncArrayHandle handle) { return static_cast<jsonc::array_type*>(handle)->size(); }

void jsonc_array_clear(JsoncArrayHandle handle) { return static_cast<jsonc::array_type*>(handle)->clear(); }

bool jsonc_array_remove(JsoncArrayHandle handle, size_t index) { return static_cast<jsonc::array_type*>(handle)->erase(index); }
...
JsoncObjectHandle jsonc_create_object() { return new jsonc::object_type(); }
JsoncArrayHandle  jsonc_create_array() { return new jsonc::array_type(); }

void jsonc_free_object(JsoncObjectHandle handle) { delete static_cast<jsonc::object_type*>(handle); }
void jsonc_free_array(JsoncArrayHandle handle) { delete static_cast<jsonc::array_type*>(handle); }
void jsonc_free_type_variant(JsoncTypeVariantHandle handle) { delete static_cast<jsonc::jsonc*>(handle); }
