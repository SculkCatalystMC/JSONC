...
JSONC_API enum JsoncValueType jsonc_get_variant_type(jsonc_variant_t handle);
...
JSONC_API enum JsoncValueType jsonc_object_get_type(jsonc_object_t handle, const char* key);
...
JSONC_API enum JsoncValueType jsonc_array_get_type(jsonc_array_t handle, size_t index);
...
JSONC_API const char*         jsonc_array_get_any_int(jsonc_object_t handle, size_t index); // Need release buffer
JSONC_API bool                jsonc_array_set_any_int(jsonc_object_t handle, size_t index, const char* value);
