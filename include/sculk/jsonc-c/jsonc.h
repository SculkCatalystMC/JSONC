...
JSONC_API long double jsonc_variant_to_float(jsonc_variant_t handle);
...
JSONC_API size_t         jsonc_variant_get_comments_before(jsonc_variant_t handle, char* data, size_t length);
JSONC_API size_t         jsonc_variant_get_comments_after(jsonc_variant_t handle, char* data, size_t length);
...
JSONC_API size_t jsonc_variant_dump(
...
JSONC_API size_t         jsonc_object_get_any_int(jsonc_object_t handle, char* data, size_t length, const char* key);
JSONC_API bool           jsonc_object_set_any_int(jsonc_object_t handle, const char* key, const char* value);
JSONC_API long double    jsonc_object_get_float(jsonc_object_t handle, const char* key);
JSONC_API void           jsonc_object_set_float(jsonc_object_t handle, const char* key, long double value);
JSONC_API size_t         jsonc_object_get_any_float(jsonc_object_t handle, char* data, size_t length, const char* key);
JSONC_API bool           jsonc_object_set_any_float(jsonc_object_t handle, const char* key, const char* value);
JSONC_API size_t         jsonc_object_get_any_number(jsonc_object_t handle, char* data, size_t length, const char* key);
...
JSONC_API size_t jsonc_object_dump(
...
JSONC_API size_t jsonc_object_get_key_comments_before(jsonc_object_t handle, char* data, size_t length, const char* key);
JSONC_API size_t jsonc_object_get_key_comments_after(jsonc_object_t handle, char* data, size_t length, const char* key);
JSONC_API size_t jsonc_object_get_value_comments_before(jsonc_object_t handle, char* data, size_t length, const char* key);
JSONC_API size_t jsonc_object_get_value_comments_after(jsonc_object_t handle, char* data, size_t length, const char* key);
JSONC_API void   jsonc_object_set_key_comments_before(jsonc_object_t handle, const char* key, const char* comments);
...
JSONC_API size_t         jsonc_array_get_any_int(jsonc_array_t handle, char* data, size_t length, size_t index);
...
JSONC_API void           jsonc_array_set_float(jsonc_array_t handle, size_t index, long double value);
JSONC_API void           jsonc_array_add_float(jsonc_array_t handle, long double value);
JSONC_API size_t         jsonc_array_get_any_float(jsonc_array_t handle, char* data, size_t length, size_t index);
...
JSONC_API size_t         jsonc_array_get_any_number(jsonc_array_t handle, char* data, size_t length, size_t index);
...
JSONC_API size_t jsonc_array_dump(
...
JSONC_API size_t jsonc_array_get_comments_before(jsonc_object_t handle, char* data, size_t length, size_t index);
JSONC_API size_t jsonc_array_get_comments_after(jsonc_object_t handle, char* data, size_t length, size_t index);
